 <?php
  class M_007
  {
    ...
    {
      // คำสั่ง SQL  
      $sql = "SELECT * FROM m_007_tb WHERE taskName = :taskName ORDER BY createdAt DESC";
    ...
    {
      // คำสั่ง SQL  
      $sql = "SELECT * FROM m_007_tb WHERE taskDetail LIKE :taskDetail AND taskStatus = 1 ORDER BY createdAt DESC";
      // คลีนข้อมูลที่ใช้เป็นเงื่อนไขที่รันเข้ามา
    ...
    {
      $sql = "INSERT INTO m_007_tb (taskName, taskDetail, taskStatus) VALUES (:taskName, :taskDetail, :taskStatus)";
    ...
    {
      $sql = "UPDATE m_007_tb SET taskName = :taskName, taskDetail = :taskDetail, taskStatus = :taskStatus WHERE id = :id";
    ...
    {
      $sql = "DELETE FROM m_007_tb WHERE id =:id";
      $id =  intval(htmlspecialchars(strip_tags($id)));
